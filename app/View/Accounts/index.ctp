                     ...
                     <td class="actions text-center">
                        ...
                        <?php echo $this->Html->link(__(''), array('controller' => 'Accounts','action' => 'viewHistory', $account['Account']['id']), array('data-reqtitle' => $account['Account']['ac_type'],'icon' => 'view', 'class' => 'viewAccountHistory no-hover-text-decoration', 'title' => __('Click here to view this Account History.'))); 
                            if($account['Account']['ac_type']=='bus'){
                                echo $this->Html->link(__(''), array('controller' => 'BusDetails','action' => 'view', $account['Account']['ac_type_id']), array('target' => '_blank','icon'=>'fa fa-eye','title' => __('Click here to view details')));
                            }elseif($account['Account']['ac_type']=='hotel'){
                                echo $this->Html->link(__(''), array('controller' => 'HotelBooking','action' => 'view', $account['Account']['ac_type_id']), array('target' => '_blank','icon'=>'fa fa-eye','title' => __('Click here to view details')));
                            }elseif($account['Account']['ac_type']=='car'){
                                echo $this->Html->link(__(''), array('controller' => 'CarDetails','action' => 'view', $account['Account']['ac_type_id']), array('target' => '_blank','icon'=>'fa fa-eye','title' => __('Click here to view details')));                
                            }elseif($account['Account']['ac_type']=='train'){
                                echo $this->Html->link(__(''), array('controller' => 'TrainDetails','action' => 'view', $account['Account']['ac_type_id']), array('target' => '_blank','icon'=>'fa fa-eye','title' => __('Click here to view details')));             
                            }elseif($account['Account']['ac_type']=='flight'){
                                echo $this->Html->link(__(''), array('controller' => 'FlightDetails','action' => 'view', $account['Account']['ac_type_id']), array('target' => '_blank','icon'=>'fa fa-eye','title' => __('Click here to view details')));        
                            }

 ...
 */
$formParamter = '';
$this->assign('pagetitle', __('%s City', $dbOpration));
$this->Custom->addCrumb(__('%s City', $dbOpration));
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo $this->Form->create('City', array('id' => 'UserEditProfileForm','class'=>'multiple_save', 'type' => 'file', 'inputDefaults' => array('dir' => 'ltl', 'class' => 'form-control', 'div' => array('class' => 'form-group')))); ?>
                <?php echo $this->Form->input('id', array('type' => 'hidden')); ?>
                <div class="row no-margin">
                    <div class="col-md-6">
                        <?php
                            echo $this->Form->input('state_id',array('class' => 'form-control','options'=>$states,'empty' => __('Select State'), 'div' => array('class' => 'form-group required')));
                            echo $this->Form->input('name', array('tabindex' => 1,'placeholder' => __('Enter City'), 'label' => __('City'),'div' => array('class' => 'form-group required')));
                        ?> 
                    </div>
                </div>

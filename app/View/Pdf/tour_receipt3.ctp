...
$cus_total_payment3 = $voucher['total_payment3'];
...
$gst_total3 = get_total_gst($cus_total_payment3,$gst_percent);
...
$cus_final_total_payment3 = get_gst_amount($cus_total_payment3,$gst_percent);
...
<table border="1" style="padding:5px;">
	...
	<tbody>
		...
		<td style="width:25%">$customer_tour_name3</td>
		<td class="pad-two">$payment_type</td>
		<td>$cus_total_payment3</td>
		<td>$gst_total3</td>
		<td style="width:21.5%">$cus_final_total_payment3</td>
		</tr>
	</tbody>
</table>

...
$app = APP.'webroot/img/car_voucher_logo.png';
$rupee = APP.'webroot/img/rupee.png';
$pdf = new XTCPDF('L', PDF_UNIT, 'A4', true, 'UTF-8', false); 
// set document information 
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('SilShine Car Voucher');
$pdf->SetTitle('SilShine Car Voucher');
$pdf->SetSubject('Invoice Voucher');
...
<table style="width:115%;">
	<tr>
		...
		<td> <b></b></td>		
		<td> <b></b></td>		
		<td style="width:120px;"><b>Pick up place</b></td>
		<td> <b>:</b> $source</td>
	</tr>	
</table>
<table style="width:115%;">
	<tr>
		<td style="width:120px;"><b>Pick up date</b></td>
		<td> <b>:</b> $pick_up_date</td>
		<td><b></b></td>
		<td> <b></b></td>		
		<td> <b></b></td>		
		<td style="width:120px;"><b>Drop place</b></td>
		<td> <b>:</b> $destination</td>		
	</tr>	
</table>
<table style="width:115%;">
<tr>
		<td style="width:120px;"><b>Drop date</b></td>
		<td> <b>:</b> $drop_date</td>
		<td><b></b></td>
		<td> <b></b></td>		
		<td> <b></b></td>		
...
<br>
<br>
<table border="1" style="padding:5px;width:121%;">
	<thead>
		<tr>

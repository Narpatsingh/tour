...
<br />
		...
		<tr>
			<td width="20%">
				<img src="$package_photo" class="package_photo" width="300px" height="180px"><br><img src="$package_photo2" class="package_photo" width="300px" height="180px"><br><img src="$package_photo3" class="package_photo" width="300px" height="180px">
			</td>
			<td width="2%"></td>
			<td width="400px" >
...
<table class="first" cellpadding="4" cellspacing="6" nobr="true">
 ...
 <tr>
  <td width="30" align="center">1.</td>
  <td width="140">$customer_tour_type2</td>
  <td width="140">$customer_tour_name2</td>
  <td width="80">$customer_tour_date2</td>
  <td width="80">$meal_plan2</td>
  <td align="center" width="90">$customer_travel_type2</td>
 </tr>
 <tr style="border:none"></tr><tr style="border:none"></tr>
 <tr>
  <td width="90" align="center"><b>Hotel Name</b></td>
...
<tr>
  ...
  <td width="100">$hotel_contact_no2</td>
...
<table class="first" cellpadding="4" cellspacing="6" nobr="true">
 ...
 <tr>
  <td width="30" align="center">1.</td>
  <td width="140">$customer_tour_type3</td>
  <td width="140">$customer_tour_name3</td>
  <td width="80">$customer_tour_date3</td>
  <td width="80">$meal_plan3</td>
  <td align="center" width="90">$customer_travel_type3</td>
 </tr>
 <tr style="border:none"></tr><tr style="border:none"></tr>
 <tr>
  <td width="90" align="center"><b>Hotel Name</b></td>
...
<tr>
  ...
  <td width="100">$hotel_contact_no3</td>

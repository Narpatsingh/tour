 ...
 */
	public function paginate($object = null, $scope = array(), $whitelist = array()) {
		...
		/**
		 * Added By Santosh Yadav to solve issue of Paginate Not Found Issue Start
		 * */
		 $count = 0;
		...
		/**
		 * Added By Santosh Yadav to solve issue of Paginate Not Found Issue End
		 * */
		...
		$page = max(min($page, $pageCount), 1);
		/**
		 * Commented By Santosh Yadav to solve issue of Paginate Not Found Issue Start
		 * */
		 /*
